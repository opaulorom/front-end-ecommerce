...
//   onClick={() => { setShowBorder(index); handleThumbnailClick(variation.color, index) }}
// />
...
//             // Defina o preço padrão
//             setCurrentPrice(response.data.product.variations[0].price);
//             setProductLoaded(true); // Indique que os detalhes do produto foram carregados
//           }
//         }
//       } catch (error) {
//         console.error("Erro ao obter detalhes do produto:", error);
...
//     // Verifique se o preço atual é zero
